...
create table CLIENTES(
	cpf decimal(11) constraint CLIENTES_pk primary key,
	email varchar(128) not null,
	senha varchar(128) not null, 
	nome varchar(256) not null,
	telefone varchar(13),
	sexo char(2), --F (feminino), M (masculino), NB (não binário) ou ND (não declarado)
	nascimento date --Formato padrão: “aaaa-mm-dd”
	);

create table PROFISSIONAIS(
	cpf decimal(11) constraint PROFISSIONAIS_pk primary key,
	email varchar(128) not null,
	senha varchar(64) not null, 
	nome varchar(128) not null,
	area varchar(128) not null, --(medicina, advocacia, psicologia) 
	especialidade varchar(128) not null --(médico cardiologista, advogado criminal, psicólogo infantil, etc)
	);

create table CONSULTAS(
	id bigint not null auto_increment constraint CONSULTAS_pk primary key,
	...
	agendamento datetime --Formato padrão: “aaaa-mm-dd hh:mm:ss" --FALTA COLOCAR RESTRIÇÕES
	);
